        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row space-y-4 md:space-x-4 md:space-y-0">
                <div class="w-full md:w-1/3 lg:w-1/4 space-y-2">
                    <a href="{{ route('billing-portal.subscription.index') }}"
                    ...
                    <a href="{{ route('billing-portal.payment-method.index') }}"
                    ...
                    <a href="{{ route('billing-portal.invoice.index') }}"
                    ...
                    <div class="flex space-x-2 text-gray-500 hover:bg-gray-200 p-3 rounded-lg">
                        <a href="{{ route('billing-portal.portal') }}" method="post" as="button">
