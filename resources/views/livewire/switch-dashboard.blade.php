<div x-data="{ dropdownOpen: false, show: @entangle('show') }" x-show="show" class="relative">
    <button @click.away="dropdownOpen = false" @click="dropdownOpen = !dropdownOpen"
        ...
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 250.364 250.364" style="enable-background:new 0 0 250.364 250.364;"
            xml:space="preserve">
            <g>
                <g>
                    <g id="XMLID_21_">
                        <g>
                            <g>
                                <path style="fill:#4EFFBB;"
                                    d="M132.337,14.31c65.059,0,118.027,52.933,118.027,118.027
                ...
                <g>
                    <g id="XMLID_19_">
                        <g>
                            ...
                            <g>
                                <path style="fill:#222051;"
                                    d="M218.849,94.582c2.259,9.706,3.152,19.932,2.451,30.467
    ...
    <div x-show="dropdownOpen" x-cloak style="right: 40px;"
        class="absolute mt-2 rounded-md overflow-hidden shadow-xl z-20">
        <button style="width: 147px" wire:click="switchDashboard('system')"
            class="{{ $dashboard == 'system' ? 'bg-gray-800 text-white' : 'text-gray-800' }} block px-6 py-2 text-md border-b hover:text-white hover:bg-gray-500">{{ __('System') }}</button>
        <button style="width: 147px" wire:click="switchDashboard('platform')"
            class="{{ $dashboard == 'platform' ? 'bg-gray-800 text-white' : 'text-gray-800' }} block px-6 py-2 text-md border-b hover:text-white hover:bg-gray-500">{{ __('Platform') }}</button>
    </div>
</div>
