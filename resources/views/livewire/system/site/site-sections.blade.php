<div class="md:grid">
    <div class="flex justify-between">
        ...
        <button onclick='Livewire.emit("openModal", "octo-system-site-section")' style="height: 36px" onclick=""
            type="button"
            class="inline-flex h-7 items-center px-3 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
