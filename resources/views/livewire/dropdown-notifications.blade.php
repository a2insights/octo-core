<div class="xl:flex mt-2 items-center space-x-5 items-center">
    <div x-data="{ dropdownOpen: false }" class="relative my-32">
        ...
        <div x-show="dropdownOpen" class="absolute right-0 rounded-md shadow-lg overflow-hidden z-20" style="width:20rem;">
            <div class="bg-gray-100">
                ...
                @empty
                    <h3 class="mx-auto text-2xl text-center">All caught!</h3>
                @endforelse
            </div>
